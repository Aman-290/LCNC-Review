...
\emph{School of Computer Engineering}\\
\emph{Manipal Institute of Technology}\\
Manipal, India\\
...
\midrule
Ajimati et al. \cite{p18} & Adoption of low-code/no-code development. & Adoption patterns and future research agenda. & This paper adds a newer AI-era corpus, LLM-supported LCNC systems, agentic no-code tools, and a separate quality-appraisal summary. \\
Liwanag et al. \cite{p11} & LCNC development in the era of artificial intelligence. & Intersection of LCNC and AI. & This paper combines AI automation with enterprise governance, citizen development, platform comparison, quality issues, and extraction artifacts from a 50-paper corpus. \\
Rokis and Kirikova \cite{p29} & Broad low-code development literature. & Conceptual and platform-oriented literature review. & This paper focuses on recent 2024--2026 evidence and explicitly maps benefits, challenges, methods, themes, and future directions. \\
Trieflinger et al. \cite{p15} & Potentials and risks of low-code development. & Benefits and risk profile from an SLR. & This paper adds recent LLM/no-code automation papers and separates high-impact but thinly evidenced risk areas such as security and privacy. \\
\bottomrule
\end{tabularx}
\end{table*}
...
The review followed a PRISMA-informed systematic mapping workflow rather than a fully registered PRISMA 2020 protocol. This distinction is important. The corpus was constructed systematically and documented in project spreadsheets, per-paper JSON files, and extraction workbooks, but the protocol was not preregistered and database-native export logs were not preserved for every search source. The method is therefore described as a transparent review workflow with PRISMA-style reporting, not as a fully reproducible registered PRISMA review. To reduce ambiguity, the repository now contains the completed extraction workbook, PDF manifests, per-paper JSON outputs, a search/reproducibility log, per-paper quality appraisal CSV, evidence quote CSV, theme matrix CSV, and a working PRISMA checklist table.
...
\caption{PRISMA-style screening flow from 170 candidate records to 50 included studies.}
\label{fig:prisma}
\end{figure*}
